...
const RegisterPage = () => {
    ...
    return (
        <div className="font-sans text-gray-900 antialiased min-h-screen flex flex-col justify-center items-center">
            ...
            <GSingnInBtn setErrorR={setError} action={'register'}/>
                <Formik
                ...
                > 
                    {({ isSubmitting }) => (
                        <Form>
                            ...
                            <div className="mt-4">
                                <label className="block font-medium text-sm text-gray-700" htmlFor="confirm_password">
                                    Confirm Password
                                </label>
                                <div className="relative">
                                    <Field
